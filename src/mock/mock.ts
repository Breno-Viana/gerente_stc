...
export const residents: Residents[] = [
  {name: 'Ana', months_not_paid: 0, on_time: true, last_pay: '2025-08-15'},
  {name: 'Bruno', months_not_paid: 1, on_time: false, last_pay: '2025-07-20'},
  {name: 'Carla', months_not_paid: 2, on_time: false, last_pay: '2025-06-10'},
  {name: 'Diego', months_not_paid: 0, on_time: true, last_pay: '2025-08-12'},
  {name: 'Elisa', months_not_paid: 3, on_time: false, last_pay: '2025-05-30'},
  {name: 'Fernando', months_not_paid: 0, on_time: true, last_pay: '2025-08-05'},
  {name: 'Gabriela', months_not_paid: 1, on_time: false, last_pay: '2025-07-25'},
  {name: 'Hugo', months_not_paid: 0, on_time: true, last_pay: '2025-08-01'},
  {name: 'Isabela', months_not_paid: 2, on_time: false, last_pay: '2025-06-18'},
  {name: 'João', months_not_paid: 0, on_time: true, last_pay: '2025-08-10'},  {name: 'Ana', months_not_paid: 0, on_time: true, last_pay: '2025-08-15'},
  {name: 'Bruno', months_not_paid: 1, on_time: false, last_pay: '2025-07-20'},
  {name: 'Carla', months_not_paid: 2, on_time: false, last_pay: '2025-06-10'},
  {name: 'Diego', months_not_paid: 0, on_time: true, last_pay: '2025-08-12'},
  {name: 'Elisa', months_not_paid: 3, on_time: false, last_pay: '2025-05-30'},
  ...
  {name: 'Hugo', months_not_paid: 0, on_time: true, last_pay: '2025-08-01'},
  {name: 'Isabela', months_not_paid: 2, on_time: false, last_pay: '2025-06-18'},
  {name: 'João', months_not_paid: 0, on_time: true, last_pay: '2025-08-10'},
];
